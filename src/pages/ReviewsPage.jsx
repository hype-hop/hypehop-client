    ...
    <div className="Reviews">
      ...
      {Array.isArray(data?.reviews) ? (
        data.reviews.map((review) => (
          <div>
            <div id={review._id} className="card-content ">
              <div>
                <img style={{ width: '50px', height: '50px' }} src={review.user.image} alt="user-image" />
                <Typography
                  // variant='body1'
                  color="primary"
                  component="a"
              ...
              <a href={`/album/review/${review._id}`} target="_blank">
                ...
                <div className="content-body">{review.body}</div>
              </a>
            </div>
